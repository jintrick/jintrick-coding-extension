...
var require_js = __commonJS({
  "hooks/scripts/linters/js.cjs"(exports2, module2) {
    var acorn = require_acorn();
    var path = require("path");
    module2.exports = function(content, filePath, tool_name) {
    ...
    function formatError(e, filePath, tool_name) {
      ...
      return {
        ...
        systemMessage: `\u{1F6AB} JS Syntax Error: ${tool_name} \u3067\u66F8\u304D\u8FBC\u3082\u3046\u3068\u3057\u305F ${filePath} \u306B\u69CB\u6587\u30A8\u30E9\u30FC\u304C\u3042\u308A\u307E\u3059\u3002
\u4F4D\u7F6E: ${loc}
\u30A8\u30E9\u30FC: ${message}`
      };
    }
