# Get started with Gemini Code Assist tools
...
2. Grant your users the
   [required IAM roles](https://developers.google.com/gemini-code-assist/docs/set-up-gemini-standard-enterprise#grant-iam) to allow them to use Gemini Code Assist.
3. Ask your administrator to [Enable tools](https://developers.google.com/gemini-code-assist/docs/tools-agents/enable-tools-standard-enterprise).
4. To connect your GitHub or GitLab account, follow the
   instructions in
   [Configure tools](https://developers.google.com/gemini-code-assist/docs/tools-agents/configure-tools-standard-enterprise).
